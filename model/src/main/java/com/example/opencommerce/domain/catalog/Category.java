...
import com.example.opencommerce.domain.catalog.exceptions.CategoryNotFoundException;
...
public class Category {
    ...
    public static Category newCatalog() {
    ...
    public Category addChildToThisCategory(String title, String description) {
        requireNonNull(title);
        requireNonNull(description);
    ...
    public void addChildToCategoryWithId(CategoryId categoryId, String title, String description) {
        requireNonNull(title);
    ...
    public List<CategoryId> findAllSubcategoryIdsFor(CategoryId categoryId) {
        Optional<Category> categoryById = getRoot().findCategoryById(categoryId);
